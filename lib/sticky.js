...
function createStickyStore(opts = {}) {
    ...
    function prefer(token, outbounds, now = Date.now()) {
        const choice = choose(token, outbounds, now);
